...
{decided|to}';
    ...
    {
        return [
            ['minimum', null, InputOption::VALUE_OPTIONAL, 'Generate This Minimum Number of Tutorials', 5],
            ['user', null, InputOption::VALUE_OPTIONAL, 'Genereate Tutorials for this user', 1],
        ];
    }
     ...
     * @name SpinTax
     *
     * @var string Text containing our {spintax|spuntext}
     *
     * @return string Text with random spintax selections
     */
